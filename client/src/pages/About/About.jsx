  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <div className="grid items-center gap-10 lg:grid-cols-2">
        <div>
          <p className="text-sm font-medium text-brand-700 dark:text-brand-400">Our Story</p>
        ...
        <img
          src="https://images.unsplash.com/photo-1666214280557-f1b5022eb634?w=800&h=700&fit=crop"
